...
ref_pattern = re.compile('[A-Za-z]+(\d+)')
def get_reference_number(ref):
...
for group in grouped:
    ...
    group_sort_by_ref = sorted(group, key=lambda x: get_reference_number(x.getRef()))
    for component in group_sort_by_ref:
